...
public class ThreadSafeIndexedSetTest {
	 ...
	 */
	@Nested
	@DisplayName("Group 1: Approach Tests")
	public class Group1_Tests extends StaticApproachTests {
	 ...
	 */
	@Nested
	@DisplayName("Group 2: Add Tests")
	public class Group2_Tests extends StaticAddTests {
	 ...
	 */
	@Nested
	@DisplayName("Group 3: Add and Get Tests")
	public class Group3_Tests extends StaticAddGetTests {
	 ...
	 */
	@Nested
	@DisplayName("Group 4: Complex Tests")
	public class Group4_Tests extends StaticComplexTests {
	...
	public static class StaticApproachTests {
		/**
		...
		public void testOverridden() {
			Set<String> expected = Arrays.stream(IndexedSet.class.getDeclaredMethods()).map(method -> methodName(method))
					.collect(Collectors.toSet());

			// remove copy(boolean) method --- does not need overwriting
			expected.remove("copy(boolean)");
		...
		public void testNotOverridden() {
			...
			Assertions.assertTrue(!actual.contains(expected), () -> String.format(debug, expected));
		}

	}

	/**
	 * Tests add methods for {@link ThreadSafeIndexedSet} class.
	 */
	@TestMethodOrder(OrderAnnotation.class)
	public static class StaticAddTests {
		/**
	...
	/**
	 * Tests add and get methods for {@link ThreadSafeIndexedSet} class.
	 */
	@TestMethodOrder(OrderAnnotation.class)
	public static class StaticAddGetTests {
		/**
		 * Tests that {@link ThreadSafeIndexedSet} works as expected with multiple
	...
	/**
	 * Tests multiple concurrent operations for {@link ThreadSafeIndexedSet} class.
	 */
	@TestMethodOrder(OrderAnnotation.class)
	public static class StaticComplexTests {
		/**
		 * Tests that {@link ThreadSafeIndexedSet} works as expected with multiple
		 * threads reading and writing at the same time. Runs several times to make
		 * sure the results are consistent.
	...
	/**
	 * Convenience method to generate collections with {@link Integer} objects
